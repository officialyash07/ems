...
const initialMeetings = [
  {
    id: 1,
    title: "Supply Chain Optimization Sync",
    datetime: "Mon, Feb 16, 2026 at 09:30 AM",
    participants: "Logistics Mgr, Warehouse Leads, COO",
    status: "Scheduled",
  },
  {
    id: 2,
    title: "Weekly Fleet Maintenance Review",
    datetime: "Wed, Feb 18, 2026 at 02:00 PM",
    participants: "Technical Ops Team, Fleet Supervisor",
    status: "Scheduled",
  },
  {
    id: 3,
    title: "Q1 Operational Budget Audit",
    datetime: "Fri, Feb 20, 2026 at 11:00 AM",
    participants: "Finance Ops, COO, Procurement Head",
    status: "Scheduled",
  },
];
...
const CooMeetings = () => {
  ...
  const handleCreate = () => {
    ...
    const newMeeting = {
      ...
      participants: form.participants || "Operations Staff",
      status: "Scheduled",
    };
        ...
        {meetings.map((m) => (
          ...
          >
            ...
            <div className="mt-5 flex items-center justify-between border-t pt-4">
              ...
              <button
                onClick={() => navigate(`/coo/coo-meeting-room/${m.id}`)}
