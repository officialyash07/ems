...
const TlInternTask = () => {
  ...
  /**
   * Appends a newly assigned task to the local management list.
   *
   * @param {object} newTask - New task configuration
   */
            ...
            {tasks.map((t) => (
              <tr key={t.id}>
                <td className="px-4 py-3 flex items-center gap-3">
                  <img src={t.intern.avatar} className="h-8 w-8 rounded-full" />
                  {t.intern.name}
                </td>
