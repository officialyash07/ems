...
const tlData = {
  channels: [
    ...
    },
    {
      ...
      description: "Milestones & progress",
      type: "channel",
    },
    {
      id: "code-reviews",
  ...
  groups: [
    {
      ...
      name: "Lead Sync",
      role: "Leadership",
      avatar: "https://ui-avatars.com/api/?name=LS&background=6366f1&color=fff",
      type: "group",
    },
    {
      id: "frontend-team",
      name: "Frontend Team",
      role: "Dev Group",
      avatar: "https://ui-avatars.com/api/?name=FE&background=ec4899&color=fff",
      type: "group",
    },
    {
      id: "backend-team",
      name: "Backend Team",
      role: "Dev Group",
      avatar: "https://ui-avatars.com/api/?name=BE&background=8b5cf6&color=fff",
      type: "group",
    },
  ],
};
...
const initialMessages = {
  general: [
    {
      from: "Sarah Jenkins",
      text: "Does anyone have the latest API docs?",
      time: "10:30 AM",
      mine: false,
      type: "text",
    },
  ...
  "lead-sync": [
    {
      from: "Manager",
      text: "Let's align on the roadmap for Q3.",
      time: "Mon",
      mine: false,
      type: "text",
    },
  ...
  return (
    <div className="flex h-[calc(100vh-6rem)] rounded-xl border border-gray-300 bg-white overflow-hidden shadow-sm">
      ...
      <div className="w-80 border-r border-gray-300 bg-slate-50 flex flex-col">
        <div className="p-4">
          <h2 className="font-bold text-xl text-slate-800">Team Lead Chat</h2>
        </div>
