                ...
                item.status === "pending" && (
                  <div className="flex gap-2">
                    <button
                      ...
                      className="bg-green-500 hover:bg-green-600 text-white h-6 px-2 text-[13px] rounded"
                    >
                      Approve
                    </button>
                    ...
                    <button
                     ...
                     className="bg-red-500 hover:bg-red-600 text-white h-6 px-2 text-[13px] rounded"
                    >
                      Reject
                    </button>
                  </div>
